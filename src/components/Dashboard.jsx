...
export default function Dashboard({ onAddTrade }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Monthly Configuration - Simplified */}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-baseline gap-4">
              ...
              <span className={`flex items-center gap-1 text-base font-semibold ${
                stats.monthPnLPercent >= 0 ? 'text-success' : 'text-danger'
              }`}>
                {stats.monthPnLPercent >= 0 ? (
                  <ArrowUpRight className="w-4 h-4" />
                ) : (
                  <ArrowDownRight className="w-4 h-4" />
                )}
                {formatPercent(stats.monthPnLPercent)}
              </span>
            </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <div className="stat-card">
          ...
          <span className="text-2xl font-bold text-text">{stats.totalTrades}</span>
